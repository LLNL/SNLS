...
extern __snls_hdev__ int    SNLS_LUP_Solve       (real8  *a ,         real8 *x, real8 *b, int n,           real8 tol=1e-50);
extern __snls_hdev__ int    SNLS_LUP_SolveX      (real8  *a ,         real8 *xb,          int n, int nRHS, real8 tol=1e-50);
